...
import com.masai.Service.CustomersLogInServiceImpl;
...
public class LoginController {
	...
	@Autowired
	private CustomersLogInServiceImpl userLogInServiceImpl;
	...
	// for user login
		...
		public String logInUser(@RequestBody CustomersDto userDTO) throws Exception {
